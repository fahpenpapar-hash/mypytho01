# คำสั่งรับค่าข้อความ  string ทางเป็นพิมฑื ใช้ฟังก์ชั่น input()
# ****** ตัวแปร variable คือ ชื่อที่ Dev ตั้งขึ้นมาเอง (ต้องเป็นไปตามกฎการตั้งชื่อ) เอาไว้เก็บข้อมูลที่เกิดชึ้นในโปรแกรม
